...
func TestHopefullyNothingBroke(t *testing.T) {
	...
	// 		},
	// 	},
	// 	ContentChanges: []protocol.Msg_TextDocumentContentChangeEvent{
	// 		{
	// 			Text: string(f),
	// 		},
	// 		// ContentChanges: []protocol.Lit_TextDocumentContentChangeEvent_Item1{
	// 	},
	// }

	// err = pylspSC.(*generic.GenericServiceClient).Conn.Notify(ctx, "textDocument/didChange", didChange)
	// if err != nil {
	// 	panic(err)
	// }
