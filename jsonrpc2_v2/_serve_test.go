...
import (
	...
	"github.com/konveyor/analyzer-lsp/lsp/stack/stacktest"
	// "github.com/konveyor/analyzer-lsp/lsp/testenv"
)
...
func TestServe(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"tcp",
			func(ctx context.Context, t testing.TB) (jsonrpc2.Listener, error) {
				// testenv.NeedsLocalhostNet(t)
