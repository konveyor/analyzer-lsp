...
func (UnimplementedProviderCodeLocationServiceServer) GetCodeSnip(context.Context, *GetCodeSnipRequest) (*GetCodeSnipResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCodeSnip not implemented")
}
...
func RegisterProviderCodeLocationServiceServer(s grpc.ServiceRegistrar, srv ProviderCodeLocationServiceServer) {
	// If the following call panics, it indicates UnimplementedProviderCodeLocationServiceServer was
...
func (UnimplementedProviderDependencyLocationServiceServer) GetDependencyLocation(context.Context, *GetDependencyLocationRequest) (*GetDependencyLocationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDependencyLocation not implemented")
}
...
func RegisterProviderDependencyLocationServiceServer(s grpc.ServiceRegistrar, srv ProviderDependencyLocationServiceServer) {
	// If the following call panics, it indicates UnimplementedProviderDependencyLocationServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
const (
	...
	ProviderService_StreamPrepareProgress_FullMethodName = "/provider.ProviderService/StreamPrepareProgress"
)
...
func (UnimplementedProviderServiceServer) GetDependenciesDAG(context.Context, *ServiceRequest) (*DependencyDAGResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDependenciesDAG not implemented")
}
func (UnimplementedProviderServiceServer) NotifyFileChanges(context.Context, *NotifyFileChangesRequest) (*NotifyFileChangesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NotifyFileChanges not implemented")
}
...
func _ProviderService_StreamPrepareProgress_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PrepareProgressRequest)
...
var ProviderService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "StreamPrepareProgress",
			Handler:       _ProviderService_StreamPrepareProgress_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "provider/internal/grpc/library.proto",
