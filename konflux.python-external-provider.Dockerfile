...
RUN go mod edit -replace=github.com/konveyor/analyzer-lsp=../../ && CGO_ENABLED=1 go build -mod=readonly -tags strictfipsruntime -a -o python-external-provider main.go
